...
class AutomationTask:
    ...
    def _save_excel(self, df, src_path):
        ...
        # Set all columns as text to prevent scientific notation in Excel
            ...
            try:
                ...
                while time.time() < deadline:
                    try:
                        ...
                        page.reload() # Sometimes needed to refresh status? Or just click Generate again?
                        # Original script logic re-clicks Generate if needed or just waits. 
                        # Let's rely on wait for now or implementing a refresh button click if available.
                        # Original uses wait_for_timeout loop.
                        time.sleep(5)
                        # Re-click generate if enabled?
